...
def check_argv():
    ...
    parser.add_argument(
        "input_pairs_fn", type=str, help="input pairs file in Aren's format"
        )
    parser.add_argument(
        "speakers_fn", type=str, help="file containing the speakers"
        )
    parser.add_argument(
        "output_pairs_fn", type=str, help="output pairs file in Aren's format"
        )
    if len(sys.argv) == 1:
        parser.print_help()
        sys.exit(1)
