...
"""
Analyse a given Buckeye speaker list.
...
def check_argv():
    ...
    parser.add_argument("list_fn", type=str, help="utterances list to analyse")
    if len(sys.argv) == 1:
        parser.print_help()
        sys.exit(1)
...
def main():
    ...
    # Read speaker information:speaker gender, speaker age, interviewer gender
    speaker_info = dict(
        [(line.split()[0], line.split()[1:]) for line in open(speakers_list_fn)
